...
<div class="w w1 header clearfix">
    <div id="logo"><a href="http://www.bsweb.com/"><img src="/images/jt-logo.png" alt="京淘商城"/></a></div>
        ...
        <div id="wizard" class="checkout-steps">
            <div id="step-1" class="step step-complete">
                <div class="step-title">
                    ...
                    <strong id="consigneeTitleDiv">物流信息</strong>
                    <%--<span class="step-action" id="consignee_edit_action"><a href="#none"
                                                                            onclick="edit_Consignee()">[修改]</a></span>--%>
                </div>
                            ...
                            <div class="s-content">
                                ...
                                <form id="orderForm" class="">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="orderShipping.receiverName" id="receiverName" value="陈晨"/>
                                    </div>
                                    <div>
                                        <label for="receiverMobile">电话</label>
                                        <input type="text" name="orderShipping.receiverMobile" id="receiverMobile" value="13800807944"/>
                                    </div>
                                    <div>
                                        <label for="receiverMobile">省份</label>
                                        <input type="text" name="orderShipping.receiverState" value="黑龙江省"/>
                                    </div>
                                    <div>
                                        <label for="receiverMobile">城市</label>
                                        <input type="text" name="orderShipping.receiverCity" value="哈尔滨"/>
                                    </div>
                                    <div>
                                        <label for="receiverMobile">区/县</label>
                                        <input type="text" name="orderShipping.receiverDistrict" value="南岗区"/>
                                    </div>
                                    <div>
                                        <label for="receiverMobile">收货地址</label>
                                        <input type="text" name="orderShipping.receiverAddress" value="黑龙江大学"/>
                                    </div>
                                </form>
                                <%--<p>
                                    陈晨 &nbsp; 15800807944 &nbsp; &nbsp;
           ...
           <%-- <div id="step-2" class="step step-complete"><a name="payAndShipFocus"></a>
                <div class="step-title">
                    ...
                    <span class="step-action" id="payment-ship_edit_action"><a href="#none"
                                                                               onclick="edit_Payment(false)">[修改]</a></span>
                </div>
                &lt;%&ndash;<div class="step-content">
                    <div id="payment-ship" class="sbox-wrap">
                        <div class="sbox">
                            <div class="s-content payment-info">
                                ...
                                <div class="way-list">
                                    <div class="way-item">
                                        京淘快递&nbsp;&nbsp;中小件商品&nbsp;&nbsp;<font color='#FF6600;'>工作日、双休日与假日均可送货</font>
                                        &nbsp;
		...
		<table class="order-table">
			...
			<c:forEach items="${carts }" var="cart">
				  <tr>
				    <td class="fore1">
					   <div class="p-goods">
						  <div class="p-img"><a href="http://www.bsweb.com/item/${cart.itemId}.html"
                                                target='_blank'><img width="52" height="52" src="${cart.itemImage}"></a></div>
							 <div class="p-detail">
								<div class="p-name">
									<a href="http://www.bsweb.com/item/${cart.itemId}.html" target='_blank'>
                                            ${cart.itemTitle }
                                    </a>
								</div>
								...
								<span id="promise_1057746" class="promise411"></span>
					  				  ...
					  				  <td class="p-price"><strong>￥<fmt:formatNumber groupingUsed="false"
                                                                                     maxFractionDigits="2"
                                                                                     minFractionDigits="2"
                                                                                     value="${cart.itemPrice /100}"/></strong>
					  </td>
					  				  <td class="p-promotion"> </td>
    ...
    <!--********滿贈套装結束*********-->
                                    ...
                                    <div class="order-summary">
                                        ...
                                        <div class="statistic fr">
                                            <div class="list"><span><em id="span-skuNum">1</em> 件商品，总商品金额：</span><em
                                                    ...
                                                    value="${totalPrice/100 }"/></em></div>
                                            <div class="list"><span>返现：</span><em class="price" id="cachBackId"
                                                                                  v="0.00"> -￥0.00</em></div>
                    ...
                    <div id="checkout-floatbar" class="checkout-buttons group">
                        <div class="inner">
                            ...
                            <span class="total">应付总额：<strong id="payPriceId">￥<fmt:formatNumber groupingUsed="false"
                                                                                                maxFractionDigits="2"
                                                                                                minFractionDigits="2"
                                                                                                value="${totalPrice/100 }"/></strong>元
	    							</span>
                            ...
                            <div style="display:none" id="factoryShipCodShowDivBottom" class="dispatching">
                                部分商品货到付款方式：先由京淘配送“提货单”并收款，然后厂商发货。
                            </div>
                        </div>
