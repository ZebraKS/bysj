...
<%--	<div id="logo"><a href="http://www.bsweb.com/"><img clstag="clickcart|keycount|xincart|logo" src="/images/jt-logo.png" title="返回京淘商城首页" alt="返回京淘商城首页"></a></div>
    ...
    <input type="button" value="跳转首页"
           onclick="javascrtpt:window.location.href='http://www.bsweb.com/'">
</div>
<div class="w cart">
	<div class="cart-hd group">
		<h2>我的购物车</h2>
		<span id="show2" class="fore">
 </span>
	</div>
	<div id="show">
	        ...
	        <div id="product_11345721" data-bind="rowid:1" class="item item_selected ">
		        <div class="item_form clearfix">
		            ...
		            <div class="cell p-goods">
		                <div class="p-img">
		                	<a href="http://www.bsweb.com/items/${cart.itemId }.html" target="_blank">
		                		<img clstag="clickcart|keycount|xincart|p-imglistcart" src="${cart.itemImage}" alt="${cart.itemTitle}" width="52" height="52">
		                	</a>
		                </div>    
		                <div class="p-name">
		                	<a href="http://www.bsweb.com/items/${cart.itemId }.html" clstag="clickcart|keycount|xincart|productnamelink" target="_blank">${cart.itemTitle}</a>
        ...
        <div class="ui-ceilinglamp-1" style="width: 988px; height: 49px;"><div class="cart-dibu ui-ceilinglamp-current" style="width: 988px; height: 49px;">
          <div class="control fdibu fdibucurrent">
              ...
              <span class="shopping">
                  ...
                  <a href="http://www.bsweb.com/" target="_blank" clstag="clickcart|keycount|xincart|coudanlink" id="continue">继续购物</a>
              </span>
          </div>
