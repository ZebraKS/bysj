...
<form id="orderForm" class="hide">
    ...
    <input type="hidden" name="orderShipping.receiverMobile" value="13800000000"/>
...
<div class="w w1 header clearfix">
    <div id="logo"><input type="button" value="跳转首页"
                          onclick="javascrtpt:window.location.href='http://www.bsweb.com/'"></div>
		...
		<table class="order-table">
			<tbody>
				  <tr>
				    <td class="fore1">
					   <div class="p-goods">
						  <div class="p-img"><a href="http://www.bsweb.com/item/${item.id}.html" target='_blank'><img
                                  width="52" height="52" src="${item.images[0]}"></a></div>
							 <div class="p-detail">
								<div class="p-name">
									<a href="http://www.bsweb.com/item/${item.id}.html" target='_blank'>
                                        ${item.title }
                                    </a>
								</div>
